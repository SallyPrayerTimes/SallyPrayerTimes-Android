...
public class UserConfig {
    ...
    private String battery_optimization;//battery optimization for notification
    private String widget_background_color;//widget background color
    ...
    public String getBattery_optimization() {
        return battery_optimization;
    }

    public void setBattery_optimization(String battery_optimization) { this.battery_optimization = battery_optimization; }

    public String getWidget_background_color() {
        return widget_background_color;
    }

    public void setWidget_background_color(String widget_background_color) { this.widget_background_color = widget_background_color; }
