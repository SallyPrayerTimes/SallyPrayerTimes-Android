...
public class PrayersTimes{
    ...
    public PrayersTimes(Calendar cal , UserConfig userConfig){
    ...
    public void setParameters(UserConfig userConfig) {//set all parameters to PrayersTimes object for calculate the prayer times
        ...
        this.timeZone = Double.valueOf(userConfig.getTimezone());//set zone time from user selected city zone time
